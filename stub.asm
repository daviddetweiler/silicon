...
; I have an idea: a tiny, "keyed" RNG generating a bitstream used to "decode" the decompressor stub and the compressed
; blob itself. I.e. even more obfuscation :kek:. Pick a seed value that looks like the rest of the file?
